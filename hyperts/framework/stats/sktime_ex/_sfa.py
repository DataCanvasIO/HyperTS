...
from hyperts.framework.stats.sktime_ex.panel import check_X
from hyperts.framework.stats.sktime_ex._base import BaseEstimator
...
Panel = Union[pd.DataFrame, np.ndarray]
